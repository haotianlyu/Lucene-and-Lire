...
<input type="submit" value="upload">
          ...
          <div class="col-md-3 col_2">
				<h3>No Result is searched!</h3><br>
				<h3>Maybe your input has problem!</h3><br>
				<h3>Maybe the data is not exist!</h3><br>
				<h3>The system support only the Chinese keyword search!</h3><br>
				<h3>You could do search again by click <a href="Index.jsp">this</a></h3>
			</div>
             <div class="clearfix"> </div>
    </div>
	<div class="grid_2">
