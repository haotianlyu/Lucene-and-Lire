<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="com.Bean.SimilarityBean" %>
...
<input type="submit" value="upload">
	  ...
	  <div class="col-md-10 sap_tabs">	
	       <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
			  ...
			  <%String text=(String)request.getAttribute("upload.message"); %>
				   ...
				   <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
						<ul class="tab_img">
						  <% 
						   ...
						   sim=(List<SimilarityBean>)request.getAttribute("simlist");
						   System.out.println(sim.size());
						   for(int i=0;i<sim.size();i++){%>
						   <li><a href="SearchLireServlet?photoid=<%=sim.get(i).getPicturepath()%>">
							 <img src="images/photodatabase/graph/<%=sim.get(i).getPicturepath()%>" class="img-responsive" onerror=this.src='images/default.jpg' alt=""/>
						     <div class="tab_desc">
							   <p><div style="width: 100px; background: #ccc; overflow: hidden; white-space: nowrap;  text-overflow: ellipsis; ">Difference:</div></p>
								<h4><%=sim.get(i).getSimilarity()%>%</h4>
						  </div>
					      </a></li>
					      <%} %>
						   <div class="clearfix"></div>
