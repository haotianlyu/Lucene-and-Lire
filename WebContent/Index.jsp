...
<meta name="keywords" content="Film-Hub Responsive web template, Bootstrap Web Templates, Flat Web Templates, Andriod Compatible web template, 
...
<script language="javascript">
   function checkNull(){
	   if(document.getElementById("search_text").value==""||document.getElementById("search_text").value==null){alert("Search context can not be empty");return false;} 
   else 
	   return true;}
</script> 
<script language="javascript">
	...
	<div class="banner">
		<div class="container">
			<div class="span_1_of_1">
			    <h2>fILM HUB,SEARCH WHAT YOU WANT!</h2>
			    <div class="search">
			      <ul class="nav1">
		            <li id="search">
						<form action="DosearchServlet" method="get" onsubmit="return checkNull()">
							<input type="hidden"  name="field" value="name">
							<input type="hidden"  name="searchtype" value="whole">
							<input type="text" name="search_text" id="search_text" placeholder="Search"/>
							<input type="submit" name="search_submit" id="search_submit" value="&nbsp;"/>                        
						</form>
					</li>
					<li id="options">
						<a href="Index.jsp">fresh</a>
						<!--  <ul class="subnav">
							<li><a href="#">全信息</a></li>
							<li><a href="#">图片</a></li>
							<li><a href="#">影视</a></li>
...
<input type="submit" value="upload">
	...
	<div class="grid_3">
	  <div class="container">
         ...
         <p>Copyright &copy; 2016.Haotian Lyu All rights reserved.</p>
	  </div>
	</div>
</body>
</html>	